...
/* harmony import */ var _utils_data_manager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/data-manager */ "./src/utils/data-manager.js");




const getPrice = () => (0,_utils_tools__WEBPACK_IMPORTED_MODULE_0__.getRandomInteger)(10, 100) * 10;

const generatePoint = () => {
  const {
    beginDate,
    endDate
  } = (0,_utils_data_manager__WEBPACK_IMPORTED_MODULE_1__.generateDates)();
  return {
    'basePrice': getPrice(),
    'dateFrom': beginDate,
    'dateTo': endDate,
    'tripDuration': (0,_utils_data_manager__WEBPACK_IMPORTED_MODULE_1__.getDuration)(beginDate, endDate),
    'destination': (0,_utils_data_manager__WEBPACK_IMPORTED_MODULE_1__.getRandomDestination)(),
    'isFavorite': Boolean((0,_utils_tools__WEBPACK_IMPORTED_MODULE_0__.getRandomInteger)(0, 1)),
    'offers': (0,_utils_data_manager__WEBPACK_IMPORTED_MODULE_1__.generateOffers)(),
    'type': (0,_utils_data_manager__WEBPACK_IMPORTED_MODULE_1__.getType)(),
...
class FilterModel extends _utils_abstract_observable_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(...args) {
    ...
    _classPrivateFieldInitSpec(this, _filter, {
      writable: true,
      value: _utils_constants__WEBPACK_IMPORTED_MODULE_1__.filterType.everything
    });
...
class PointsModel extends _utils_abstract_observable__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  updatePoint(typeOfUpdate, toUpdate) {
    const index = _classPrivateFieldGet(this, _points).findIndex(point => point.id === toUpdate.id);

    if (index === -1) {
      throw new Error('Update point doesn\'t exist');
    }

    _classPrivateFieldSet(this, _points, [..._classPrivateFieldGet(this, _points).slice(0, index), toUpdate, ..._classPrivateFieldGet(this, _points).slice(index + 1)]);
...
/***/ "./src/presenter/create-point-presenter.js":
/*!*************************************************!*\
  !*** ./src/presenter/create-point-presenter.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PointCreatePresenter)
/* harmony export */ });
...
/* harmony import */ var _utils_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/constants */ "./src/utils/constants.js");
/* harmony import */ var _view_form_creation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/form-creation */ "./src/view/form-creation.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
class PointCreatePresenter {
  constructor(pointListContainer, changeData) {
    ...
    _defineProperty(this, "init", () => {
      ...
      _classPrivateFieldSet(this, _pointAddComponent, new _view_form_creation__WEBPACK_IMPORTED_MODULE_2__["default"]());
      ...
      (0,_utils_rendering__WEBPACK_IMPORTED_MODULE_0__.renderItem)(_classPrivateFieldGet(this, _pointListContainer), _classPrivateFieldGet(this, _pointAddComponent), _utils_rendering__WEBPACK_IMPORTED_MODULE_0__.importPositions.afterBegin);
    ...
    _defineProperty(this, "destroy", () => {
      ...
      (0,_utils_rendering__WEBPACK_IMPORTED_MODULE_0__.remove)(_classPrivateFieldGet(this, _pointAddComponent));
    ...
    _classPrivateFieldInitSpec(this, _handleFormSubmit, {
      writable: true,
      value: task => {
        _classPrivateFieldGet(this, _changeData).call(this, _utils_constants__WEBPACK_IMPORTED_MODULE_1__.userAction.addPoint, _utils_constants__WEBPACK_IMPORTED_MODULE_1__.updateType.minor, // Пока у нас нет сервера, который бы после сохранения
...
/* harmony import */ var _utils_rendering__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/rendering */ "./src/utils/rendering.js");
...
class FilterPresenter {
  constructor(filterContainer, filterModel, tasksModel) {
    ...
    _defineProperty(this, "init", () => {
      ...
      _classPrivateFieldSet(this, _filterComponent, new _view_filter__WEBPACK_IMPORTED_MODULE_0__["default"](_classPrivateFieldGet(this, _filterModel).filter));
      ...
      if (prevFilterComponent === null) {
        (0,_utils_rendering__WEBPACK_IMPORTED_MODULE_1__.renderItem)(_classPrivateFieldGet(this, _filterContainer), _classPrivateFieldGet(this, _filterComponent), _utils_rendering__WEBPACK_IMPORTED_MODULE_1__.importPositions.beforeEnd);
        return;
      }

      (0,_utils_rendering__WEBPACK_IMPORTED_MODULE_1__.replace)(_classPrivateFieldGet(this, _filterComponent), prevFilterComponent);
      (0,_utils_rendering__WEBPACK_IMPORTED_MODULE_1__.remove)(prevFilterComponent);
    });
    ...
    _classPrivateFieldInitSpec(this, _handleFilterTypeChange, {
      ...
      value: filterType => {
        ...
        _classPrivateFieldGet(this, _filterModel).setFilter(_utils_constants__WEBPACK_IMPORTED_MODULE_2__.updateType.major, filterType);
      }
    });
...
class PointPresenter {
  constructor(tripPointsListElement, changeData, changeState) {
    ...
    _classPrivateFieldInitSpec(this, _handleFavoriteClick, {
      writable: true,
      value: () => {
        _classPrivateFieldGet(this, _changeData).call(this, _utils_constants__WEBPACK_IMPORTED_MODULE_3__.userAction.updatePoint, _utils_constants__WEBPACK_IMPORTED_MODULE_3__.updateType.minor, { ..._classPrivateFieldGet(this, _point),
    ...
    _classPrivateFieldInitSpec(this, _handleFormSubmit, {
      ...
      value: point => {
        ...
        _classPrivateFieldGet(this, _changeData).call(this, _utils_constants__WEBPACK_IMPORTED_MODULE_3__.userAction.updatePoint, _utils_constants__WEBPACK_IMPORTED_MODULE_3__.updateType.minor, point);
    ...
    _classPrivateFieldInitSpec(this, _handleDeleteClick, {
      writable: true,
      value: task => {
        _classPrivateFieldGet(this, _changeData).call(this, _utils_constants__WEBPACK_IMPORTED_MODULE_3__.userAction.removePoint, _utils_constants__WEBPACK_IMPORTED_MODULE_3__.updateType.minor, task);
      }
    });
...
/* harmony import */ var _view_route_info__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/route-info */ "./src/view/route-info.js");
/* harmony import */ var _view_travel_list__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/travel-list */ "./src/view/travel-list.js");
/* harmony import */ var _view_no_entries__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/no-entries */ "./src/view/no-entries.js");
...
/* harmony import */ var _utils_rendering__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utils/rendering */ "./src/utils/rendering.js");
/* harmony import */ var _create_point_presenter__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./create-point-presenter */ "./src/presenter/create-point-presenter.js");
...
/* harmony import */ var _utils_data_manager__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utils/data-manager */ "./src/utils/data-manager.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var _handleUserAction = /*#__PURE__*/new WeakMap();
...
class TripPresenter {
  constructor(mainElement, pointsModel, filterModel) {
    ...
    _classPrivateFieldInitSpec(this, _tripPointsListElement, {
      writable: true,
      value: new _view_travel_list__WEBPACK_IMPORTED_MODULE_3__["default"]()
    });
    ...
    _classPrivateFieldInitSpec(this, _currentSortType, {
      writable: true,
      value: _utils_constants__WEBPACK_IMPORTED_MODULE_6__.sortBy.day
    });

    _classPrivateFieldInitSpec(this, _currentFilter, {
      writable: true,
      value: _utils_constants__WEBPACK_IMPORTED_MODULE_6__.filterType.everything
    });
    ...
    _defineProperty(this, "createPoint", () => {
      _classPrivateFieldSet(this, _currentSortType, _utils_constants__WEBPACK_IMPORTED_MODULE_6__.sortBy.day);
    ...
    _classPrivateFieldInitSpec(this, _renderHeader, {
      writable: true,
      value: () => {
        (0,_utils_rendering__WEBPACK_IMPORTED_MODULE_7__.renderItem)(_classPrivateFieldGet(this, _headerNavigationContainer), _classPrivateFieldGet(this, _headerComponent), _utils_rendering__WEBPACK_IMPORTED_MODULE_7__.importPositions.beforeEnd);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderNoTasks, {
      writable: true,
      value: () => {
        _classPrivateFieldSet(this, _noTripPointsComponent, new _view_no_entries__WEBPACK_IMPORTED_MODULE_4__["default"](_classPrivateFieldGet(this, _currentFilter)));

        (0,_utils_rendering__WEBPACK_IMPORTED_MODULE_7__.renderItem)(_classPrivateFieldGet(this, _tripEventsElement), _classPrivateFieldGet(this, _noTripPointsComponent), _utils_rendering__WEBPACK_IMPORTED_MODULE_7__.importPositions.beforeEnd);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderTripPointsListElement, {
      writable: true,
      value: () => {
        (0,_utils_rendering__WEBPACK_IMPORTED_MODULE_7__.renderItem)(_classPrivateFieldGet(this, _tripEventsElement), _classPrivateFieldGet(this, _tripPointsListElement), _utils_rendering__WEBPACK_IMPORTED_MODULE_7__.importPositions.beforeEnd);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _handleUserAction, {
      writable: true,
      value: (actionType, typeOfUpdate, toUpdate) => {
        switch (actionType) {
          case _utils_constants__WEBPACK_IMPORTED_MODULE_6__.userAction.updatePoint:
            _classPrivateFieldGet(this, _pointsModel).updatePoint(typeOfUpdate, toUpdate);

            break;

          case _utils_constants__WEBPACK_IMPORTED_MODULE_6__.userAction.addPoint:
            _classPrivateFieldGet(this, _pointsModel).addPoint(typeOfUpdate, toUpdate);

            break;

          case _utils_constants__WEBPACK_IMPORTED_MODULE_6__.userAction.removePoint:
            _classPrivateFieldGet(this, _pointsModel).deletePoint(typeOfUpdate, toUpdate);
    ...
    _classPrivateFieldInitSpec(this, _handleModelEvent, {
      writable: true,
      value: (typeOfUpdate, data) => {
        switch (typeOfUpdate) {
          case _utils_constants__WEBPACK_IMPORTED_MODULE_6__.updateType.patch:
            _classPrivateFieldGet(this, _pointPresenter).get(data.id).init(data);

            break;

          case _utils_constants__WEBPACK_IMPORTED_MODULE_6__.updateType.minor:
            _classPrivateFieldGet(this, _clearMain).call(this);
          ...
          case _utils_constants__WEBPACK_IMPORTED_MODULE_6__.updateType.major:
            _classPrivateFieldGet(this, _clearMain).call(this, true);
    ...
    _classPrivateFieldInitSpec(this, _clearMain, {
      ...
      value: (resetSort = false) => {
        ...
        (0,_utils_rendering__WEBPACK_IMPORTED_MODULE_7__.remove)(_classPrivateFieldGet(this, _tripSortComponent));
        (0,_utils_rendering__WEBPACK_IMPORTED_MODULE_7__.remove)(_classPrivateFieldGet(this, _tripInfoComponent));
        ...
        if (_classPrivateFieldGet(this, _noTripPointsComponent)) {
          (0,_utils_rendering__WEBPACK_IMPORTED_MODULE_7__.remove)(_classPrivateFieldGet(this, _noTripPointsComponent));
        }
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderSort, {
      writable: true,
      value: () => {
        _classPrivateFieldSet(this, _tripSortComponent, new _view_sort__WEBPACK_IMPORTED_MODULE_1__["default"](_classPrivateFieldGet(this, _currentSortType)));

        _classPrivateFieldGet(this, _tripSortComponent).setSortTypeChangeHandler(_classPrivateFieldGet(this, _handleSortTypeChange));

        (0,_utils_rendering__WEBPACK_IMPORTED_MODULE_7__.renderItem)(_classPrivateFieldGet(this, _tripEventsElement), _classPrivateFieldGet(this, _tripSortComponent), _utils_rendering__WEBPACK_IMPORTED_MODULE_7__.importPositions.afterBegin);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderTripInfo, {
      writable: true,
      value: points => {
        _classPrivateFieldSet(this, _tripInfoComponent, new _view_route_info__WEBPACK_IMPORTED_MODULE_2__["default"](points.sort((0,_utils_items_manager__WEBPACK_IMPORTED_MODULE_9__.sortItemsBy)(_utils_constants__WEBPACK_IMPORTED_MODULE_6__.sortBy.day))));

        (0,_utils_rendering__WEBPACK_IMPORTED_MODULE_7__.renderItem)(_classPrivateFieldGet(this, _infoTripContainer), _classPrivateFieldGet(this, _tripInfoComponent), _utils_rendering__WEBPACK_IMPORTED_MODULE_7__.importPositions.afterBegin);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderTripPoint, {
      writable: true,
      value: point => {
        const pointPresenter = new _point_presenter__WEBPACK_IMPORTED_MODULE_5__["default"](_classPrivateFieldGet(this, _tripPointsListElement), _classPrivateFieldGet(this, _handleUserAction), _classPrivateFieldGet(this, _handleModeChange));
    ...
    _classPrivateFieldInitSpec(this, _renderTripPointsList, {
      ...
      value: points => {
        points.forEach(point => {
          _classPrivateFieldGet(this, _renderTripPoint).call(this, point);
        });
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderMain, {
      ...
      value: () => {
        ...
        _classPrivateFieldGet(this, _renderTripInfo).call(this, points);
      }
    });
    ...
    _classPrivateFieldSet(this, _newPointPresenter, new _create_point_presenter__WEBPACK_IMPORTED_MODULE_8__["default"](_classPrivateFieldGet(this, _tripPointsListElement), _classPrivateFieldGet(this, _handleUserAction)));
  ...
  get points() {
    _classPrivateFieldSet(this, _currentFilter, _classPrivateFieldGet(this, _filterModel).filter);

    const points = _classPrivateFieldGet(this, _pointsModel).points;

    const filteredPoints = _utils_data_manager__WEBPACK_IMPORTED_MODULE_10__.filter[_classPrivateFieldGet(this, _currentFilter)](points);

    return filteredPoints.sort((0,_utils_items_manager__WEBPACK_IMPORTED_MODULE_9__.sortItemsBy)(_classPrivateFieldGet(this, _currentSortType)));
  }
...
/* harmony export */ });
const createOfferListComponent = (offers, type) => {
  const createOfferComponent = offer => {
    ...
    return `<div class="event__available-offers">
                      <div class="event__offer-selector">
                        <input class="event__offer-checkbox  visually-hidden" id="event-offer-${type}-${id}" type="checkbox" value="${id}" name="event-offer-${type}" ${isChecked}>
...
/* harmony export */   "offerTitles": () => (/* binding */ offerTitles),
/* harmony export */   "descriptionSentences": () => (/* binding */ descriptionSentences),
...
const offerTitles = () => ['Add luggage', 'Order Uber', 'Switch to comfort', 'Rent a car', 'Add breakfast', 'Book tickets', 'Lunch in city'];
...
/* harmony export */   "generateDestination": () => (/* binding */ generateDestination),
/* harmony export */   "getTotalPrice": () => (/* binding */ getTotalPrice),
/* harmony export */   "filter": () => (/* binding */ filter),
/* harmony export */   "isDatesEqual": () => (/* binding */ isDatesEqual),
/* harmony export */   "getRandomDestination": () => (/* binding */ getRandomDestination),
/* harmony export */   "getType": () => (/* binding */ getType)
/* harmony export */ });
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constants */ "./src/utils/constants.js");
/* harmony import */ var _tools__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tools */ "./src/utils/tools.js");
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! dayjs */ "./node_modules/dayjs/dayjs.min.js");
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_2__);



const generateOffers = (isEmptyPoint = false) => {
  const result = {};

  for (const type of (0,_constants__WEBPACK_IMPORTED_MODULE_0__.eventTypes)()) {
    const offers = [];
    const titles = (0,_constants__WEBPACK_IMPORTED_MODULE_0__.offerTitles)();

    for (let j = 0; j < (0,_tools__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(0, 5); j++) {
      const nextTitle = (0,_tools__WEBPACK_IMPORTED_MODULE_1__.getRandomElement)(titles).element;
      offers.push({
        id: j + 1,
        title: nextTitle,
        price: (0,_tools__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(2, 30) * 10,
        isActive: isEmptyPoint ? false : Boolean((0,_tools__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(0, 1))
      });
...
const getPictures = () => {
  const picturesCount = (0,_tools__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(1, 10);
  const pictures = [];
...
const getDescription = () => {
  const sentences = (0,_constants__WEBPACK_IMPORTED_MODULE_0__.descriptionSentences)();
  const sentencesCount = (0,_tools__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(1, 5);
  const description = [];

  for (let i = 0; i < sentencesCount; i++) {
    const nextElement = (0,_tools__WEBPACK_IMPORTED_MODULE_1__.getRandomElement)(sentences);
...
const generateDates = lastPointTime => {
  let beginDate = (lastPointTime === null || lastPointTime === void 0 ? void 0 : lastPointTime.endDate) || dayjs__WEBPACK_IMPORTED_MODULE_2___default()().minute(0);

  const getBeginDateMinutes = () => (0,_tools__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(12, 2000) * 10;

  const getMinutesGap = () => (0,_tools__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(6, 36) * 10;
...
const generateDestination = () => {
  const availableDestinations = (0,_constants__WEBPACK_IMPORTED_MODULE_0__.destinations)();
...
const getTotalPrice = point => {
  ...
  res += point.offers[point.type].reduce((accum, offer) => offer.isActive ? accum + offer.price : accum, 0);
  return res;
};
const filter = {
  [_constants__WEBPACK_IMPORTED_MODULE_0__.filterType.everything]: points => points.filter(point => point),
  [_constants__WEBPACK_IMPORTED_MODULE_0__.filterType.future]: points => points.filter(point => new Date(point.dateFrom) > new Date()),
  [_constants__WEBPACK_IMPORTED_MODULE_0__.filterType.past]: points => points.filter(point => new Date(point.dateTo) < new Date())
};
const isDatesEqual = (dateA, dateB) => dateA === null && dateB === null || dayjs__WEBPACK_IMPORTED_MODULE_2___default()(dateA).isSame(dateB);
const getRandomDestination = () => (0,_tools__WEBPACK_IMPORTED_MODULE_1__.getRandomElement)(generateDestination()).element;
const getType = () => (0,_tools__WEBPACK_IMPORTED_MODULE_1__.getRandomElement)((0,_constants__WEBPACK_IMPORTED_MODULE_0__.eventTypes)()).element;
...
/* harmony export */ });
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constants */ "./src/utils/constants.js");
/* harmony import */ var _data_manager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./data-manager */ "./src/utils/data-manager.js");
...
const sortItemsBy = sortType => {
  switch (sortType) {
    case _constants__WEBPACK_IMPORTED_MODULE_0__.sortBy.day:
      return (a, b) => a.dateFrom - b.dateFrom;

    case _constants__WEBPACK_IMPORTED_MODULE_0__.sortBy.duration:
      return durationSort;

    case _constants__WEBPACK_IMPORTED_MODULE_0__.sortBy.price:
      return (a, b) => (0,_data_manager__WEBPACK_IMPORTED_MODULE_1__.getTotalPrice)(a) - (0,_data_manager__WEBPACK_IMPORTED_MODULE_1__.getTotalPrice)(b);
  }
};
...
const filterTemplate = currentFilter => `<form class="trip-filters" action="#" method="get">
                <div class="trip-filters__filter">
                  <input id="filter-everything" class="trip-filters__filter-input  visually-hidden" type="radio" name="trip-filter" value="everything" ${currentFilter === _utils_constants__WEBPACK_IMPORTED_MODULE_1__.filterType.everything ? 'checked' : ''}>
                  <label class="trip-filters__filter-label" for="filter-everything">Everything</label>
                </div>

                <div class="trip-filters__filter">
                  <input id="filter-future" class="trip-filters__filter-input  visually-hidden" type="radio" name="trip-filter" value="future" ${currentFilter === _utils_constants__WEBPACK_IMPORTED_MODULE_1__.filterType.future ? 'checked' : ''}>
                  <label class="trip-filters__filter-label" for="filter-future">Future</label>
                </div>

                <div class="trip-filters__filter">
                  <input id="filter-past" class="trip-filters__filter-input  visually-hidden" type="radio" name="trip-filter" value="past" ${currentFilter === _utils_constants__WEBPACK_IMPORTED_MODULE_1__.filterType.past ? 'checked' : ''}>
...
class FiltersView extends _abstract_class__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  get template() {
    return filterTemplate(_classPrivateFieldGet(this, _currentFilter));
  }
...
/* harmony import */ var _utils_data_manager__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utils/data-manager */ "./src/utils/data-manager.js");
...
const formCreationTemplate = tripEvent => {
  ...
  const offersList = (0,_utils_component_create__WEBPACK_IMPORTED_MODULE_2__.createOfferListComponent)(offers[eventType], eventType, true);
  const eventTypeItems = (0,_utils_component_create__WEBPACK_IMPORTED_MODULE_2__.createEventTypesListComponent)((0,_utils_constants__WEBPACK_IMPORTED_MODULE_1__.eventTypes)(), eventType);
  const photosList = (0,_utils_component_create__WEBPACK_IMPORTED_MODULE_2__.createPicturesListComponent)(destination.pictures);
  const destinationOptions = (0,_utils_component_create__WEBPACK_IMPORTED_MODULE_2__.createDestinationsListComponent)(_utils_constants__WEBPACK_IMPORTED_MODULE_1__.destinations);
...
var _changeOffersHandler = /*#__PURE__*/new WeakMap();
...
class CreationFormView extends _smart_view__WEBPACK_IMPORTED_MODULE_3__["default"] {
  constructor(_point) {
    super();
    ...
    _classPrivateFieldInitSpec(this, _setDatepicker, {
      writable: true,
      value: () => {
        _classPrivateFieldSet(this, _datepickerFrom, (0,flatpickr__WEBPACK_IMPORTED_MODULE_4__["default"])(this.element.querySelector('#event-start-time-1'), {
          enableTime: true,
        ...
        _classPrivateFieldSet(this, _datepickerTo, (0,flatpickr__WEBPACK_IMPORTED_MODULE_4__["default"])(this.element.querySelector('#event-end-time-1'), {
          enableTime: true,
          dateFormat: 'd/m/y H:i',
    ...
    _classPrivateFieldInitSpec(this, _setInnerHandlers, {
      ...
      value: () => {
        ...
        this.element.querySelector('#event-start-time-1').addEventListener('change', _classPrivateFieldGet(this, _startTimeChangeHandler));
        this.element.querySelector('#event-end-time-1').addEventListener('change', _classPrivateFieldGet(this, _endTimeChangeHandler));
        const offersElement = this.element.querySelector('.event__section--offers');

        if (offersElement) {
          offersElement.addEventListener('input', _classPrivateFieldGet(this, _changeOffersHandler));
        }
      }
    });

    _classPrivateFieldInitSpec(this, _changeOffersHandler, {
      writable: true,
      value: evt => {
        evt.preventDefault();
    ...
    _classPrivateFieldInitSpec(this, _startTimeChangeHandler, {
      ...
      value: evt => {
        ...
        this.updateData({
          ...
          tripDuration: (0,_utils_data_manager__WEBPACK_IMPORTED_MODULE_6__.getDuration)(this._point.dateFrom, this._point.dateTo)
        }, true);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _getChangedDestination, {
      ...
      value: destinationName => {
        const allDestinations = (0,_utils_data_manager__WEBPACK_IMPORTED_MODULE_6__.generateDestination)();
    ...
    this._point = CreationFormView.createEmptyPoint(_point);
...
_defineProperty(CreationFormView, "createEmptyPoint", () => {
  const date = new Date();
  return {
    basePrice: '',
    dateFrom: new Date(),
    ...
    isFavorite: false,
    offers: (0,_utils_data_manager__WEBPACK_IMPORTED_MODULE_6__.generateOffers)(true),
    type: 'check-in'
  };
});
...
/* harmony import */ var _utils_component_create__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/component-create */ "./src/utils/component-create.js");
/* harmony import */ var _utils_data_manager__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utils/data-manager */ "./src/utils/data-manager.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
const formEditTemplate = tripEvent => {
  ...
  const offersList = (0,_utils_component_create__WEBPACK_IMPORTED_MODULE_5__.createOfferListComponent)(offers[type], type);
  const eventTypeLabel = type.charAt(0).toUpperCase() + type.slice(1);
  const eventTypeItems = (0,_utils_component_create__WEBPACK_IMPORTED_MODULE_5__.createEventTypesListComponent)((0,_utils_constants__WEBPACK_IMPORTED_MODULE_1__.eventTypes)(), type);
  const destinationOptions = (0,_utils_component_create__WEBPACK_IMPORTED_MODULE_5__.createDestinationsListComponent)(_utils_constants__WEBPACK_IMPORTED_MODULE_1__.destinations);
  const photosList = (0,_utils_component_create__WEBPACK_IMPORTED_MODULE_5__.createPicturesListComponent)(destination.pictures);
  return `<li class="trip-events__item">
              <form class="event event--edit" action="#" method="post">
                <header class="event__header">
                  <div class="event__type-wrapper">
...
var _deleteClickHandler = /*#__PURE__*/new WeakMap();

var _getChangedLocation = /*#__PURE__*/new WeakMap();

class EditFormView extends _smart_view__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(_point) {
    super();
    ...
    _defineProperty(this, "reset", point => {
      this.updateData(EditFormView.parsePointToData(point));
    });

    _classPrivateFieldInitSpec(this, _setDatepicker, {
      writable: true,
      value: () => {
        _classPrivateFieldSet(this, _datepickerFrom, (0,flatpickr__WEBPACK_IMPORTED_MODULE_3__["default"])(this.element.querySelector('#event-start-time-1'), {
          enableTime: true,
          dateFormat: 'd/m/y H:i',
          defaultDate: this._point.dateFrom,
          onChange: _classPrivateFieldGet(this, _dateFromChangeHandler)
        ...
        _classPrivateFieldSet(this, _datepickerTo, (0,flatpickr__WEBPACK_IMPORTED_MODULE_3__["default"])(this.element.querySelector('#event-end-time-1'), {
          enableTime: true,
          dateFormat: 'd/m/y H:i',
          defaultDate: this._point.dateTo,
          minDate: this._point.dateFrom,
    ...
    _classPrivateFieldInitSpec(this, _destinationChangeHandler, {
      ...
      value: evt => {
        evt.preventDefault();
        this.updateData({
          destination: _classPrivateFieldGet(this, _getChangedLocation).call(this, evt.target.value)
        }, false);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _basePriceChangeHandler, {
      ...
      value: evt => {
        ...
        (0,_utils_data_manager__WEBPACK_IMPORTED_MODULE_6__.getTotalPrice)(this._point);
      }
    });
    ...
    _defineProperty(this, "setDeleteClickHandler", callback => {
      this._callback.deleteClick = callback;
      this.element.querySelector('.event__reset-btn').addEventListener('click', _classPrivateFieldGet(this, _deleteClickHandler));
    });
    ...
    _classPrivateFieldInitSpec(this, _deleteClickHandler, {
      writable: true,
      value: evt => {
        evt.preventDefault();
    ...
    _classPrivateFieldInitSpec(this, _getChangedLocation, {
      writable: true,
      value: locationName => {
        const allLocations = (0,_utils_data_manager__WEBPACK_IMPORTED_MODULE_6__.generateDestination)();
    ...
    this._point = EditFormView.parsePointToData(_point);
...
_defineProperty(EditFormView, "parsePointToData", point => ({ ...point
}));
...
/* harmony import */ var _utils_component_create__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/component-create */ "./src/utils/component-create.js");
/* harmony import */ var _utils_data_manager__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/data-manager */ "./src/utils/data-manager.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
const listedTravelTemplate = tripEvent => {
  ...
  const tripEvents = (0,_utils_component_create__WEBPACK_IMPORTED_MODULE_2__.createTripEventsListComponent)(offers[type]);
  const totalPrice = (0,_utils_data_manager__WEBPACK_IMPORTED_MODULE_3__.getTotalPrice)(tripEvent);
...
const NoPointsTextMessage = {
  [_utils_constants__WEBPACK_IMPORTED_MODULE_1__.filterType.everything]: 'Click New Event to create your first point',
  [_utils_constants__WEBPACK_IMPORTED_MODULE_1__.filterType.past]: 'There are no past events now',
  [_utils_constants__WEBPACK_IMPORTED_MODULE_1__.filterType.future]: 'There are no future events now'
};
...
class NoEntriesMessageView extends _abstract_class__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(type) {
    super();
    this._type = type;
  }
...
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _abstract_class__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./abstract-class */ "./src/view/abstract-class.js");
/* harmony import */ var _utils_data_manager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/data-manager */ "./src/utils/data-manager.js");
function _classPrivateFieldInitSpec(obj, privateMap, value) { _checkPrivateRedeclaration(obj, privateMap); privateMap.set(obj, value); }
...
const travelInfoTemplate = tripEvents => {
  ...
  const travelCost = tripEvents.reduce((sum, current) => sum + (0,_utils_data_manager__WEBPACK_IMPORTED_MODULE_2__.getTotalPrice)(current), 0);
...
class SmartView extends _abstract_class__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(...args) {
    super(...args);
...
const sortTemplate = sortType => `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
            <div class="trip-sort__item  trip-sort__item--day">
              <input id="sort-day" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-day" data-sort-type="${_utils_constants__WEBPACK_IMPORTED_MODULE_1__.sortBy.day}" ${sortType === _utils_constants__WEBPACK_IMPORTED_MODULE_1__.sortBy.day ? 'checked' : ''}>
            ...
            <div class="trip-sort__item  trip-sort__item--time">
              <input id="sort-time" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-time" data-sort-type="${_utils_constants__WEBPACK_IMPORTED_MODULE_1__.sortBy.duration}" ${sortType === _utils_constants__WEBPACK_IMPORTED_MODULE_1__.sortBy.duration ? 'checked' : ''}>
              <label class="trip-sort__btn" for="sort-time">Time</label>
            </div>

            <div class="trip-sort__item  trip-sort__item--price">
              <input id="sort-price" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-price" data-sort-type="${_utils_constants__WEBPACK_IMPORTED_MODULE_1__.sortBy.price}" ${sortType === _utils_constants__WEBPACK_IMPORTED_MODULE_1__.sortBy.price ? 'checked' : ''}>
...
class SortingView extends _abstract_class__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(sortType) {
    ...
    _classPrivateFieldInitSpec(this, _sortType, {
      writable: true,
      value: _utils_constants__WEBPACK_IMPORTED_MODULE_1__.sortBy.day
    });
  ...
  get template() {
    return sortTemplate(_classPrivateFieldGet(this, _sortType));
  }
...
/* harmony import */ var _model_points_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./model/points-model */ "./src/model/points-model.js");
/* harmony import */ var _model_filter_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./model/filter-model */ "./src/model/filter-model.js");
...
const pointsModel = new _model_points_model__WEBPACK_IMPORTED_MODULE_2__.PointsModel();
const filterModel = new _model_filter_model__WEBPACK_IMPORTED_MODULE_3__["default"]();
pointsModel.points = points;
const pageBody = document.querySelector('.page-body');
const tripFiltersElement = document.querySelector('.trip-controls__filters');
const tripPresenter = new _presenter_trip_presenter__WEBPACK_IMPORTED_MODULE_1__["default"](pageBody, pointsModel, filterModel);
const filterPresenter = new _presenter_filter_presenter__WEBPACK_IMPORTED_MODULE_4__["default"](tripFiltersElement, filterModel);

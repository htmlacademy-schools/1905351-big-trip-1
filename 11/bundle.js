...
/* harmony import */ var _utils_items_manager__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/items-manager */ "./src/utils/items-manager.js");
/* harmony import */ var _utils_rendering__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/rendering */ "./src/utils/rendering.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
class TripPresenter {
  constructor(mainElement) {
    ...
    _classPrivateFieldInitSpec(this, _currentSortType, {
      writable: true,
      value: _utils_constants__WEBPACK_IMPORTED_MODULE_7__.sortBy.day
    });
    ...
    _classPrivateFieldInitSpec(this, _renderHeader, {
      writable: true,
      value: () => {
        (0,_utils_rendering__WEBPACK_IMPORTED_MODULE_9__.renderItem)(_classPrivateFieldGet(this, _infoTripContainer), new _view_route_info__WEBPACK_IMPORTED_MODULE_3__["default"](_classPrivateFieldGet(this, _tripPoints)), _utils_rendering__WEBPACK_IMPORTED_MODULE_9__.importPositions.afterBegin);
        (0,_utils_rendering__WEBPACK_IMPORTED_MODULE_9__.renderItem)(_classPrivateFieldGet(this, _headerFiltersContainer), new _view_filter__WEBPACK_IMPORTED_MODULE_2__["default"](), _utils_rendering__WEBPACK_IMPORTED_MODULE_9__.importPositions.beforeEnd);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderNoTasks, {
      writable: true,
      value: () => {
        (0,_utils_rendering__WEBPACK_IMPORTED_MODULE_9__.renderItem)(_classPrivateFieldGet(this, _tripEventsElement), _classPrivateFieldGet(this, _noTripPointsComponent), _utils_rendering__WEBPACK_IMPORTED_MODULE_9__.importPositions.beforeEnd);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _renderTripPointsListElement, {
      writable: true,
      value: () => {
        (0,_utils_rendering__WEBPACK_IMPORTED_MODULE_9__.renderItem)(_classPrivateFieldGet(this, _tripEventsElement), _classPrivateFieldGet(this, _tripPointsListElement), _utils_rendering__WEBPACK_IMPORTED_MODULE_9__.importPositions.beforeEnd);
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _handlePointChange, {
      writable: true,
      value: updatedPoint => {
        _classPrivateFieldSet(this, _tripPoints, (0,_utils_items_manager__WEBPACK_IMPORTED_MODULE_8__.updateItems)(_classPrivateFieldGet(this, _tripPoints), updatedPoint));
    ...
    _classPrivateFieldInitSpec(this, _sortTasks, {
      writable: true,
      value: sortType => {
        _classPrivateFieldSet(this, _tripPoints, _classPrivateFieldGet(this, _tripPoints).sort((0,_utils_items_manager__WEBPACK_IMPORTED_MODULE_8__.sortItemsBy)(sortType)));
    ...
    _classPrivateFieldInitSpec(this, _renderSort, {
      writable: true,
      value: () => {
        (0,_utils_rendering__WEBPACK_IMPORTED_MODULE_9__.renderItem)(_classPrivateFieldGet(this, _tripEventsElement), _classPrivateFieldGet(this, _tripSortComponent), _utils_rendering__WEBPACK_IMPORTED_MODULE_9__.importPositions.afterBegin);
    ...
    _classPrivateFieldInitSpec(this, _renderMain, {
      ...
      value: () => {
        ...
        (0,_utils_rendering__WEBPACK_IMPORTED_MODULE_9__.renderItem)(_classPrivateFieldGet(this, _headerNavigationContainer), _classPrivateFieldGet(this, _headerComponent), _utils_rendering__WEBPACK_IMPORTED_MODULE_9__.importPositions.beforeEnd);
        ...
        if (((_classPrivateFieldGet2 = _classPrivateFieldGet(this, _tripPoints)) === null || _classPrivateFieldGet2 === void 0 ? void 0 : _classPrivateFieldGet2.length) > 0) {
          _classPrivateFieldGet(this, _renderSort).call(this); // this.#renderCreationForm();
  ...
  for (const type of (0,_constants__WEBPACK_IMPORTED_MODULE_0__.eventTypes)()) {
    ...
    for (let j = 0; j < (0,_tools__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(0, 5); j++) {
      ...
      offers.push({
        ...
        isActive: Boolean((0,_tools__WEBPACK_IMPORTED_MODULE_1__.getRandomInteger)(0, 1))
      });
...
const formEditTemplate = tripEvent => {
  ...
  const offersList = (0,_utils_component_create__WEBPACK_IMPORTED_MODULE_5__.createOfferListComponent)(offers[type]);

...
export const filterTemplate = (currentFilter) => (`<form class="trip-filters" action="#" method="get">
...
export default class FiltersView extends AbstractClassView {
  #currentFilter = null;
  ...
  get template() {
    return filterTemplate(this.#currentFilter);
  }
